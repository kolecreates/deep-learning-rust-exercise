mod optimizers {
    ...
    use crate::layers::LayerGradients;
    ...
    pub trait Optimizer<T> {
        fn optimize(&mut self, batch_avg_loss_gradients: &Vec<LayerGradients<T>>) -> Vec<LayerOptimizations<T>>;
    }
    ...
    impl Optimizer<f32> for AdamOptimizer {
        fn optimize(&mut self, batch_avg_loss_gradients: &Vec<LayerGradients<f32>>) -> Vec<LayerOptimizations<f32>> {
